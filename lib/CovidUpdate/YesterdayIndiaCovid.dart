...
Future<Covid> fetchData() async{
  final response = await http.get('https://corona.lmao.ninja/v2/countries/india?yesterday=true');
...
class Covid{
  ...
  Covid({this.cases, this.deaths, this.recovered, this.active, this.updated , this.todayDeaths,this.todayRecovered,this.critical,this.todayCases
    , this.affectedCountries, this.tests,this.population
  });
...
class YesterdayIndiaCovid extends StatefulWidget {
  @override
  _YesterdayIndiaCovidState createState() => _YesterdayIndiaCovidState();
}

class _YesterdayIndiaCovidState extends State<YesterdayIndiaCovid> {
  ...
  String _dataValue(int timeInMillis)
  {
    ...
    var formattedDate = DateFormat("hh:mm:ss").format(date);
              ...
              Expanded(
                ...
                child: DataTable(
                  ...
                  rows: [
                    ...
                    DataRow(cells: [
                      DataCell(Text('10. India Population')),
              ...
              Expanded(
                ...
                child: Card(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        Text('LastUpdate : Yesterday ${_dataValue(snapshot.data.updated)}' ,
