...
class YesterdayGlobalCovid extends StatefulWidget {
  @override
  _YesterdayGlobalCovidState createState() => _YesterdayGlobalCovidState();
}

class _YesterdayGlobalCovidState extends State<YesterdayGlobalCovid> {
