...
class TodayIndiaCovid extends StatefulWidget {
  @override
  _TodayIndiaCovidState createState() => _TodayIndiaCovidState();
}

class _TodayIndiaCovidState extends State<TodayIndiaCovid> {
